...
[AddComponentMenu("Game Audio Scripting Essentials/Adaptive Music Container")]
public class AdaptiveMusicContainer : MonoBehaviour
{
    ...
    [SerializeField] State _initialState;
    ...
    [Header("States")]
    [Range(0.0f, 1.0f)]
    [SerializeField] List<float> _stateAudio;
    [Range(0.0f, 1.0f)]
    ...
    void Start()
    {
        ...
        {
            if (!_ignoreWarnings && (_previousAverageLength != -1.0f && _previousAverageLength != _audioLayers[i].GetSFXAverageLength()))
